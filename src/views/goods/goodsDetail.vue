      ...
      <div v-show="!showAdd">
         ...
         <div v-if="aCurrent == 1" class="avueForm-content">
            <avue-form :option="goodsEditOption" v-model="goodsDetailsForm" @submit="handleRowEditSave">
               <template slot-scope="scope" slot="intr">
                  <VueTinymce v-model="goodsDetailsForm.intr" :height="200" />
               </template>
               <template slot-scope="scope" slot="desc">
                  <VueTinymce v-model="goodsDetailsForm.desc" :height="400" />
               </template>
               <template slot-scope="scope" slot="terms">
                  <VueTinymce v-model="goodsDetailsForm.terms" :height="200" />
               </template>
            </avue-form>
         </div>
      </div>
